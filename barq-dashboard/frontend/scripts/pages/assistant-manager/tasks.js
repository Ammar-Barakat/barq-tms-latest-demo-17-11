...
function renderTasks() {
  ...
  tbody.innerHTML = tasks
    ...
    <tr>
      ...
      <td>${utils.getStatusBadge(task.Status || 1)}</td>
      <td>${utils.getPriorityBadge(task.Priority || 1)}</td>
...
async function editTask(id) {
  ...
  document.getElementById("assignedToId").value = task.AssignedToId || "";
...
async function handleSubmit(e) {
  ...
  const formData = {
    ...
    AssignedToId:
      parseInt(document.getElementById("assignedToId").value) || null,
