        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountManagerId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DueDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    SpecificTime = table.Column<TimeSpan>(type: "TEXT", nullable: true),
                    Status = table.Column<string>(type: "TEXT", nullable: false),
                    Priority = table.Column<string>(type: "TEXT", nullable: false),
                    EstimatedHours = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    DriveFolderLink = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    MaterialDriveFolderLink = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    Tags = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    DelegatedBy = table.Column<int>(type: "INTEGER", nullable: true),
                    OriginalAssignerId = table.Column<int>(type: "INTEGER", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkTaskTaskId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    IsRejectionReason = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
